...
// right handed system is used in this code DEc3_2019
// code is working for tuning on Dec 4
// This is the updated version of the code on Dec 6, 2019
...
const int nmax = 5000; // was 3000 before Dec5
...
const int npeak = 2;
double Lambda_width[npeak] = {2.8, 2.85}; //6.5,8.8}
double Lambda_cent[npeak] ={1115.83,1192.55};
...
double phil[nmax];
// ((((((((((((((((((((((((((((((((   t2   (((((((((((((((((((((((((((((((((((((((((((((((((((
const int nmax_2 = 4000;   // 2400 before Dec 5
...
const int npeak_2 = 1;
double Lambda_width_2[npeak_2] = {2.98}; //6.5,8.8}
double Lambda_cent_2[npeak_2] ={1115.89};
...
void HT_optics(){
 ...
 // ))))))))))))))))))))))))))))))))))))))))) t2 ))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
  ...
  l.DrawLatex(1125,66,Form("#color[2]{#sigma = %.6g}",f1->GetParameter(2)));
  l.DrawLatex(1125,72,Form("#color[2]{mean = %.6g}",f1->GetParameter(1)));
  ...
  f1_2->SetLineWidth(1);
  h_2->Fit("f1_2","","",1110.0,1122.0);
 
  TLatex l2;
  l2.SetTextSize(0.025);
  l2.DrawLatex(1140,20,Form("#Lambda"));
  
  l2.DrawLatex(1140,24,Form("#color[2]{#sigma = %.6g}",f1_2->GetParameter(2)));
  l2.DrawLatex(1140,28,Form("#color[2]{mean = %.6g}",f1_2->GetParameter(1)));
 ...
 //++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  for(int i=0 ; i<nite ; i++){
    ...
    sprintf(tempc, "./MOM_MATRICES/MomL5_8th_%d.dat",i);
...
//double CalcMM(double ee, double* par_ep, double* par_k, double mt){ // Before Dec3
//   double pe = ee; 
//   double Ee = sqrt(me*me + pe*pe); 
//   // Ee = Ee + 0.0116;// GeV
//   TVector3 vec_e (0.0, 0.0, pe);
  ...
  
{
  ...
  for(int i=0 ; i<ntune_event ; i++){ 
    ...
    if(foil_flag[i] ==0)
      ...
      {chi_12 = chi_12 +12*pow(residual,2.0);}
  ...
  for(int i=0 ; i<ntune_event_2; i++){ 
    ...
    chi_22 = chi_22 +18*pow(residual_2,2.0);
